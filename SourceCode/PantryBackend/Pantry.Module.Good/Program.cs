...
using Pantry.Module.Good.Endpoints;
...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddHealthChecks()
            .AddNpgSql(DatabaseConfigurationManager.CreateDatabaseConfiguration(builder.Configuration).GetConnectionString(), name: "Pantry.Module.Good.Postgres");
